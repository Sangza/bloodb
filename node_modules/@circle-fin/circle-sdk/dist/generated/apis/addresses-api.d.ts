...
export declare class AddressesApi extends BaseAPI {
     ...
     */
    createBusinessDepositAddress(businessGenerateAddressRequest?: BusinessGenerateAddressRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateBusinessDepositAddressResponse>>;
    /**
     * Stores an external blockchain address. Once added, the recipient address must be verified to ensure that you know and trust each new address. Note: Circle Mint Singapore customers must verify all transfer recipients using the UI in the Circle Console, as transfers from unverified addresses will be held in `pending` status.
     * @summary Create a recipient address
     * @param {BusinessRecipientAddressCreationRequest} [businessRecipientAddressCreationRequest]
     ...
     * @memberof AddressesApi
     */
    createBusinessRecipientAddress(businessRecipientAddressCreationRequest?: BusinessRecipientAddressCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateBusinessRecipientAddressResponse>>;
    /**
     *
     * @summary List all deposit addresses
     * @param {*} [options] Override http request option.
     ...
     * @memberof AddressesApi
     */
    getBusinessDepositAddress(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetBusinessDepositAddressResponse>>;
    /**
     * Returns a list of recipient addresses that have each been verified and are eligible for transfers. Any recipient addresses pending verification are not included in the response.
     * @summary List all recipient addresses
     * @param {string} [from] Queries items created since the specified date-time (inclusive).
     ...
     * @memberof AddressesApi
     */
    listBusinessRecipientAddresses(from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListBusinessRecipientAddressesResponse>>;
}
