...
import { TokenBlockchain, UserControlledWalletsClient, Blockchain, MetadataField, AccountType, FeeLevel, EstimateContractExecutionTransactionFeeRequestBlockchain, GetTransactionTxTypeEnum, ListTransactionsOperationEnum, ListTransactionsStateEnum, ListTransactionsTxTypeEnum, ListUsersPinStatusEnum, ListUsersSecurityQuestionStatusEnum, ListUserChallengesStatusEnum, TokenStandard, UserTokenResponseData } from './clients/user-controlled-wallets';
...
declare function initiateUserControlledWalletsClient({ apiKey, baseUrl, storage, userAgent, headers, }: ClientParams): {
     ...
     * ```
     */
    refreshUserToken: ({ userId, userToken, deviceId, idempotencyKey, refreshToken, }: RefreshUserTokenInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_user_controlled_wallets.RefreshUserToken>>;
    /**
     ...
     * ```
     */
    resendOTP: ({ userToken, idempotencyKey, userId, ...input }: ResendOTPInput) => Promise<_shared_core.TrimDataResponse<_shared_clients_user_controlled_wallets.ResentOTP>>;
    /**
