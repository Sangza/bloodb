...
declare class PINAuthenticationApi extends BaseAPI {
     ...
     */
    createUser(createUserRequest: CreateUserRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<User, any>>;
    /**
     * Create a challenge for PIN setup without setting up wallets.
     * @summary Create a challenge for PIN setup
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
...
declare const SigningApiAxiosParamCreator: (configuration?: Configuration) => {
    ...
    /**
     * Generate a challenge for signing the transaction from a specific user-controlled wallet.  NOTE: Currently, this endpoint is only available for the SOL-DEVNET.
...
declare const TransactionsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createUserTransactionContractExecutionChallenge(xUserToken: string, contractExecutionTxnPinCodeRequest: ContractExecutionTxnPinCodeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateContractExecutionTransactionForEndUserResponse>>;
    /**
     * Generates a challenge for initiating an on-chain digital asset transfer from a specified user-controlled wallet
     * @summary Create a challenge for a transfer
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    getTransaction(id: string, xUserToken: string, txType?: GetTransactionTxTypeEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionResponse>>;
    /**
     * Lists all transactions. Includes details such as status, source/destination, and transaction hash.
     * @summary List transactions
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    listTransactions(xUserToken: string, blockchain?: Blockchain, destinationAddress?: string, includeAll?: boolean, operation?: ListTransactionsOperationEnum, state?: ListTransactionsStateEnum, txHash?: string, txType?: ListTransactionsTxTypeEnum, userId?: string, walletIds?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Transactions>>;
};
/**
...
declare const TransactionsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    createUserTransactionContractExecutionChallenge(xUserToken: string, contractExecutionTxnPinCodeRequest: ContractExecutionTxnPinCodeRequest, options?: any): AxiosPromise<CreateContractExecutionTransactionForEndUserResponse>;
    /**
     * Generates a challenge for initiating an on-chain digital asset transfer from a specified user-controlled wallet
     * @summary Create a challenge for a transfer
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    getTransaction(id: string, xUserToken: string, txType?: GetTransactionTxTypeEnum, options?: any): AxiosPromise<TransactionResponse>;
    /**
     * Lists all transactions. Includes details such as status, source/destination, and transaction hash.
     * @summary List transactions
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    listTransactions(xUserToken: string, blockchain?: Blockchain, destinationAddress?: string, includeAll?: boolean, operation?: ListTransactionsOperationEnum, state?: ListTransactionsStateEnum, txHash?: string, txType?: ListTransactionsTxTypeEnum, userId?: string, walletIds?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<Transactions>;
};
/**
...
declare class TransactionsApi extends BaseAPI {
     ...
     * @memberof TransactionsApi
     */
    createUserTransactionContractExecutionChallenge(xUserToken: string, contractExecutionTxnPinCodeRequest: ContractExecutionTxnPinCodeRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CreateContractExecutionTransactionForEndUserResponse, any>>;
    /**
     * Generates a challenge for initiating an on-chain digital asset transfer from a specified user-controlled wallet
     * @summary Create a challenge for a transfer
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @memberof TransactionsApi
     */
    getTransaction(id: string, xUserToken: string, txType?: GetTransactionTxTypeEnum, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<TransactionResponse, any>>;
    /**
     * Lists all transactions. Includes details such as status, source/destination, and transaction hash.
     * @summary List transactions
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @memberof TransactionsApi
     */
    listTransactions(xUserToken: string, blockchain?: Blockchain, destinationAddress?: string, includeAll?: boolean, operation?: ListTransactionsOperationEnum, state?: ListTransactionsStateEnum, txHash?: string, txType?: ListTransactionsTxTypeEnum, userId?: string, walletIds?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<Transactions, any>>;
}
/**
 * @export
 */
...
declare const UsersApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     * Create a challenge for user initialization and create wallet(s)
     * @summary Create a challenge for user initialization and create wallet(s)
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
...
declare const UsersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getUser(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>>;
    /**
     * Get user\'s PIN and Security Question statuses.
     * @summary Get user status
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    getUserByToken(xUserToken: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>>;
    /**
     * Get the status of a challenge.
     * @summary Get a challenge
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
...
declare const UsersApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    getUserByToken(xUserToken: string, options?: any): AxiosPromise<User>;
    /**
     * Get the status of a challenge.
     * @summary Get a challenge
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
...
declare class UsersApi extends BaseAPI {
     ...
     * @memberof UsersApi
     */
    getUser(id: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<User, any>>;
    /**
     * Get user\'s PIN and Security Question statuses.
     * @summary Get user status
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @memberof UsersApi
     */
    getUserByToken(xUserToken: string, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<User, any>>;
    /**
     * Get the status of a challenge.
     * @summary Get a challenge
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
...
declare const WalletsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @param {ListWalletBalanceStandardEnum} [standard] Filter by the token standard. ERC20/ERC721/ERC1155 are the standards for EVM chains, Fungible/FungibleAsset/NonFungible/NonFungibleEdition/ProgrammableNonFungible/ProgrammableNonFungibleEdition are the standards for the Solana chain.
     * @param {string} [pageBefore] A collection ID value used for pagination.  It marks the exclusive end of a page. When provided, the collection resource will return the next n items before the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.   SHOULD NOT be used in conjunction with pageAfter.
     * @param {string} [pageAfter] A collection ID value used for pagination.  It marks the exclusive begin of a page. When provided, the collection resource will return the next n items after the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.  SHOULD NOT be used in conjunction with pageBefore.
     * @param {number} [pageSize] Limits the number of items to be returned.  Some collections have a strict upper bound that will disregard this value. In case the specified value is higher than the allowed limit, the collection limit will be used.  If avoided, the collection will determine the page size itself.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    listWalletBalance: (xUserToken: string, id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: ListWalletBalanceStandardEnum, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @param {string} [name] Filter by token name.
     * @param {string} [tokenAddress] Filter by token addresses.
     * @param {ListWalletNftsStandardEnum} [standard] Filter by the token standard. ERC20/ERC721/ERC1155 are the standards for EVM chains, Fungible/FungibleAsset/NonFungible/NonFungibleEdition/ProgrammableNonFungible/ProgrammableNonFungibleEdition are the standards for the Solana chain.
     * @param {string} [pageBefore] A collection ID value used for pagination.  It marks the exclusive end of a page. When provided, the collection resource will return the next n items before the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.   SHOULD NOT be used in conjunction with pageAfter.
     * @param {string} [pageAfter] A collection ID value used for pagination.  It marks the exclusive begin of a page. When provided, the collection resource will return the next n items after the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.  SHOULD NOT be used in conjunction with pageBefore.
     * @param {number} [pageSize] Limits the number of items to be returned.  Some collections have a strict upper bound that will disregard this value. In case the specified value is higher than the allowed limit, the collection limit will be used.  If avoided, the collection will determine the page size itself.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    listWalletNfts: (xUserToken: string, id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: ListWalletNftsStandardEnum, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listWallets: (xUserToken: string, address?: string, blockchain?: Blockchain, walletSetId?: string, refId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const WalletsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listWalletBalance(xUserToken: string, id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: ListWalletBalanceStandardEnum, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Balances>>;
    /**
     * Fetches the info for all NFTs stored in a single user-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    listWalletNfts(xUserToken: string, id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: ListWalletNftsStandardEnum, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Nfts>>;
    /**
     * Retrieves a list of all user-controlled wallets that fit the specified parameters.
     * @summary List wallets
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    listWallets(xUserToken: string, address?: string, blockchain?: Blockchain, walletSetId?: string, refId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Wallets>>;
    /**
     * Updates info for a single user-controlled wallet using it\'s unique identifier.
     * @summary Update a wallet
     * @param {string} id The universally unique identifier (UUID v4) of the resource.
...
declare const WalletsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    listWalletBalance(xUserToken: string, id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: ListWalletBalanceStandardEnum, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<Balances>;
    /**
     * Fetches the info for all NFTs stored in a single user-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    listWalletNfts(xUserToken: string, id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: ListWalletNftsStandardEnum, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<Nfts>;
    /**
     * Retrieves a list of all user-controlled wallets that fit the specified parameters.
     * @summary List wallets
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @throws {RequiredError}
     */
    listWallets(xUserToken: string, address?: string, blockchain?: Blockchain, walletSetId?: string, refId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: any): AxiosPromise<Wallets>;
    /**
     * Updates info for a single user-controlled wallet using it\'s unique identifier.
     * @summary Update a wallet
     * @param {string} id The universally unique identifier (UUID v4) of the resource.
...
declare class WalletsApi extends BaseAPI {
     ...
     * @memberof WalletsApi
     */
    listWalletBalance(xUserToken: string, id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: ListWalletBalanceStandardEnum, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<Balances, any>>;
    /**
     * Fetches the info for all NFTs stored in a single user-controlled wallet, using the wallets unique identifier.
     * @summary Get NFTs for a wallet
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @memberof WalletsApi
     */
    listWalletNfts(xUserToken: string, id: string, includeAll?: boolean, name?: string, tokenAddress?: string, standard?: ListWalletNftsStandardEnum, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<Nfts, any>>;
    /**
     * Retrieves a list of all user-controlled wallets that fit the specified parameters.
     * @summary List wallets
     * @param {string} xUserToken Unique system generated JWT session token for specific user.
     ...
     * @memberof WalletsApi
     */
    listWallets(xUserToken: string, address?: string, blockchain?: Blockchain, walletSetId?: string, refId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<Wallets, any>>;
    /**
     * Updates info for a single user-controlled wallet using it\'s unique identifier.
     * @summary Update a wallet
     * @param {string} id The universally unique identifier (UUID v4) of the resource.
