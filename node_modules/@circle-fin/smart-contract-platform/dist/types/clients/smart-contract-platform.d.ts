...
declare const InteractApiAxiosParamCreator: (configuration?: Configuration) => {
    ...
    /**
     * NOTE: This endpoint is deprecated and is being replaced by [contracts/query](https://developers.circle.com/w3s/reference/querycontract) on September 30, 2024.  Read the state of a contract you\'ve imported or deployed by providing the ABI function and applicable parameters.
     * @summary (Deprecated) Execute a read function on a contract
     * @param {string} id Contract id
     * @param {ReadContractStateByIDRequest} readContractStateByIDRequest Read contract state by executing a read ABI function.
     * @param {*} [options] Override http request option.
     * @deprecated
     * @throws {RequiredError}
     */
    readContract: (id: string, readContractStateByIDRequest: ReadContractStateByIDRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
declare const InteractApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    readContract(id: string, readContractStateByIDRequest: ReadContractStateByIDRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReadContractState>>;
};
/**
...
declare const InteractApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    readContract(id: string, readContractStateByIDRequest: ReadContractStateByIDRequest, options?: any): AxiosPromise<ReadContractState>;
};
/**
...
declare class InteractApi extends BaseAPI {
     ...
     * @memberof InteractApi
     */
    readContract(id: string, readContractStateByIDRequest: ReadContractStateByIDRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<ReadContractState, any>>;
}
...
export { type AbiParametersInner, Blockchain, type Contract, type ContractDeployment, type ContractDeploymentData, type ContractDeploymentEstimateFeeRequest, type ContractDeploymentEstimateRequest, type ContractDeploymentRequest, ContractInputType, type ContractResponse, type ContractResponseData, ContractStatus, type Contracts, type ContractsData, DeployImportApi, DeployImportApiAxiosParamCreator, DeployImportApiFactory, DeployImportApiFp, type Event, type FeeEstimation, type FeeEstimationData, FeeLevel, type Function, type ImportContractRequest, InteractApi, InteractApiAxiosParamCreator, InteractApiFactory, InteractApiFp, type ModelError, type ParamType, type PatchContractRequest, type ReadContractState, type ReadContractStateByIDRequest, type ReadContractStateData, type ReadContractStateRequest, SmartContractPlatformClient, type SolFile, type TemplateContractDeployment, type TemplateContractDeploymentData, type TemplateContractDeploymentRequest, TemplatesApi, TemplatesApiAxiosParamCreator, TemplatesApiFactory, TemplatesApiFp, type TransactionFee, VerificationStatus, ViewUpdateApi, ViewUpdateApiAxiosParamCreator, ViewUpdateApiFactory, ViewUpdateApiFp };
