...
declare const SigningApiAxiosParamCreator: (configuration?: Configuration) => {
    ...
    /**
     * Sign a transaction from a specific developer-controlled wallet.  NOTE: Currently, this endpoint is only available for the SOL-DEVNET.
